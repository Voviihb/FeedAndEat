...
android {
    namespace = "com.vk_edu.feed_and_eat"
    compileSdk = 34
    ...
    buildTypes {
        ...
        release {
            ...
            buildConfigField("String", "API_BASE_URL", "\"http://51.250.2.167:8000/\"")
            proguardFiles(
...
dependencies {
    ...
    // Firebase dependencies temporarily restored for compilation
